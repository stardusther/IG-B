...
void draw_objects()
{
	...
	case OBJETO_PLY:
		...
		break;
	case ESFERA:
		esfera.draw(modo, 1.0, 0.6, 0.0, 5);
		break;
	case CONO:
		cono.draw(modo, 1.0, 0.6, 0.0, 5);
		break;
	case CILINDRO:
		cilindro.draw(modo, 1.0, 0.6, 0.0, 5);
		break;
	case ROTACION:
...
int main(int argc, char *argv[])
{
	...
	// perfil para la creación de la figura por revolución
	...
	// al bucle de eventos)
	glutCreateWindow("PRACTICA 2 - Esther García Gallego");
