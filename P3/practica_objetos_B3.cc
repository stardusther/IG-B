...
// tipos
typedef enum{CUBO, PIRAMIDE, OBJETO_PLY, ROTACION, CILINDRO, CONO, ESFERA, EXTRUSION, NINTENDO} _tipo_objeto;
...
switch (toupper(Tecla1)){
	...
	case '4':modo=SOLID_COLORS;break;
        ...
        case 'S':t_objeto=NINTENDO;break;
...
switch (Tecla1){
   case GLUT_KEY_LEFT:Observer_angle_y-=5;break;
   case GLUT_KEY_RIGHT:Observer_angle_y+=15;break;
